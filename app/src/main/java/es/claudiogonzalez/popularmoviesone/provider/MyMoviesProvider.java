...
import es.claudiogonzalez.popularmoviesone.provider.base.BaseContentProvider;
import es.claudiogonzalez.popularmoviesone.provider.favorites.FavoritesColumns;

public class MyMoviesProvider extends BaseContentProvider {
    private static final String TAG = MyMoviesProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "es.claudiogonzalez.popularmoviesone.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return MyMoviesSQLiteOpenHelper.getInstance(getContext());
    }
